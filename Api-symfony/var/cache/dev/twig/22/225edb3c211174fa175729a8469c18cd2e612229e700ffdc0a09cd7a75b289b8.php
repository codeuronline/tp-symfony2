...
\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 23, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["aElement"]) {
            // line 24
            echo "\t\t\t\t<h2>";
...
\t</div>
{% endblock %}
", "team/recursive.html.twig", "C:\\laragon\\www\\tp-symfony2\\Api-symfony\\templates\\team\\recursive.html.twig");
    }
}
