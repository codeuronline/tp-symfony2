...
\t\t<h1>";
        ...
        echo ") </h1>
\t\t<p>
\t\t\t\t\t\t<h2><img width='50px' heigh='50px' src=\"../../../img/";
        // line 23
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 23, $this->source); })()), "photo", [], "any", false, false, false, 23), "html", null, true);
        echo "\" alt=\"photo de ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 23, $this->source); })()), "firstname", [], "any", false, false, false, 23), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 23, $this->source); })()), "lastname", [], "any", false, false, false, 23), "html", null, true);
        echo "\"></h2>
\t\t\t\t\t\t<h2><a href=\"cv_";
        // line 24
...
";
    ...
    {
        return array (  107 => 24,  99 => 23,  90 => 21,  74 => 7,  67 => 6,  53 => 3,  36 => 1,);
    }
...
\t<div class=\"example-wrapper\">
\t\t<h1>{{user.firstname}} {{user.lastname}}({{user.label}}) </h1>
\t\t<p>
\t\t\t\t\t\t<h2><img width='50px' heigh='50px' src=\"../../../img/{{ user.photo }}\" alt=\"photo de {{user.firstname}} {{user.lastname}}\"></h2>
\t\t\t\t\t\t<h2><a href=\"cv_{{user.lastname}}.pdf\">le CV</h2>
\t\t\t\t\t\t<br>
\t\t</p>
\t</div>
{% endblock %}
